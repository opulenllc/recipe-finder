...
export const posts: BlogPost[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>When you are clearing out the fridge, resist every impulse to make three separate small things. Make one large thing instead. A frittata can absorb almost any combination of vegetables, cheese, and herbs you have. A big pot of soup or stew can take any protein and vegetable and benefit from the company. Fried rice is designed specifically for this situation — it is literally a dish that exists because someone needed to use up leftovers.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Recipe first cooking starts with a dish and works backward to the shopping list. If you want chicken tikka masala, you need a specific set of ingredients. If you do not have them, you buy them. Some of those ingredients — a bunch of fresh fenugreek, a can of coconut cream, a jar of specialty spice paste — may only be used partially before they are quietly forgotten at the back of the shelf.</p>
  ...
  },
  {
    ...
    content: `
      <p>I have cooked out of a lot of other people's kitchens. Friends' apartments in cities I was visiting. Rental houses on trips that went longer than planned. A farmhouse in Umbria for three weeks one autumn. A friend's place in Osaka for ten days. What I have learned from all of that borrowed counter space is that the kitchens capable of producing a great meal on short notice all share a small number of the same things. Not the same gadgets, not the same brands — the same five or six staple ingredients, used constantly and restocked without drama.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p><em>Acid at the end</em> — a squeeze of lemon or lime, a splash of vinegar, a few drops of something sharp — brightens everything and makes a dish taste complete rather than flat. It is the single most underused technique in home cooking and the one that makes the biggest difference for the smallest effort.</p>
      <p><em>Fat as a finish</em> — a knob of butter stirred into a sauce or pan at the very end, a drizzle of good olive oil over the finished plate — adds richness and rounds off sharp edges. It is what restaurant food often has that home cooking often lacks, and it takes five seconds.</p>
      <p><em>One bold seasoning</em> — a spoonful of soy sauce, a teaspoon of fish sauce, a spoonful of miso dissolved into the pan — adds the kind of savory depth that makes a meal taste like it took longer and involved more thought than it actually did. <strong>Pick one and commit to it. Do not use all three at once or they cancel each other out.</strong></p>
